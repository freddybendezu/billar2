...
{
  @RequestMapping(value={"/addCustomerPage"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
  ...
  @RequestMapping(value={"/update/{name}"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
  ...
  public ModelAndView update(HttpServletRequest request, ModelMap model)
  {
    ...
    Query query = new Query("Customer");
    query.addFilter("name", Query.FilterOperator.EQUAL, originalName);
    PreparedQuery pq = datastore.prepare(query);
  ...
  @RequestMapping(value={"/delete/{name}"}, method={org.springframework.web.bind.annotation.RequestMethod.GET})
  public ModelAndView delete(@PathVariable String name, HttpServletRequest request, ModelMap model)
  {
    ...
    datastore.delete(new Key[] { customer.getKey() });
